		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="widgets.jsp"><em class="fa fa-calendar-o"></em> Widgets <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link" href="charts.jsp"><em class="fa fa-bar-chart"></em> Charts</a></li>
